    ...
    with input_con:
        ...
        while True:
            ...
            with output_con:
                ...
                #output_cursor.execute("INSERT OR IGNORE INTO AGB (app_id,text_raw) VALUES ('{id}','{raw}')".\
                #format(id=app_id, raw=page))

                # TODO: write text_raw, text_xml and text_crawldate in
                # database
...
def new_database():
    ...
    with output_con:
       ...
       cur.execute("CREATE TABLE AGB(app_id TEXT PRIMARY KEY, text_url TEXT, text_raw TEXT, text_xml TEXT, crawler_name TEXT, text_type TEXT, text_crawldate DATE, check_auto BOOL, check_man BOOL, text_quality INTEGER, app_name TEXT, app_storename TEXT, app_permissions TEXT)")
