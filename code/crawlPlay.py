...
def main():
    """ 
    Crawling the Google playstore.
    
    :-i: Crawl initial Seed from the TOP 100 of every Category
    :-r: Crawl recursively, starting with a database full of seeds called GooglePlay.db (created by -i).
    """
    parser = OptionParser()
